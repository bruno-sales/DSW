...
public class CasamentoOfertasDAO {
	...
	//	cof.setIdOfertaCompra(rs.getInt("idOfertaCompra"));
        //      cof.setDataExecucao(rs.getDateTime("dataExecucao"));
                 
		return cof;
	}

	//@Override
	public CasamentoOfertas getCasamentosOfertaDAO(int id)
	{
	...
	public List<CasamentoOfertas> lista()
	{
		...
		List<CasamentoOfertas> lista = new ArrayList<CasamentoOfertas>();
