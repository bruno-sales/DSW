...
@WebServlet(name = "GogoServlet", urlPatterns = {"/GogoServlet"})
public class GogoServlet extends HttpServlet {
    ...
    protected void buscarPersonagens(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        request.setAttribute("personagens", lista);

        // Redireciona
        RequestDispatcher rd = request.getRequestDispatcher("/ListPersonagens.jsp");
